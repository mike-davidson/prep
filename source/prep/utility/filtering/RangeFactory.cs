...
{
    public class RangeFactory<TItemToMatch, TPropertyType> : ICreateMatchers<TItemToMatch, TPropertyType>
      where TPropertyType : IComparable<TPropertyType>
    {
        ICreateMatchers<TItemToMatch, TPropertyType> original;

        public RangeFactory(ICreateMatchers<TItemToMatch, TPropertyType> original)
        {
